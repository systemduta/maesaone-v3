...
class MITInstallCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'MIXTRA Install Command';
    ...
    public function handle()
    {
        ...
        if (file_exists(base_path('database/migrations/2019_08_19_000000_create_failed_jobs_table.php'))) {
            @unlink(base_path('database/migrations/2019_08_19_000000_create_failed_jobs_table.php'));
        }
        ...
        if ($this->confirm('Do you have setting the database configuration at .env ?')) {
            ...
            $this->info('Installing Mixtra Framework Is Completed ! Thank You :)');
        } else {
